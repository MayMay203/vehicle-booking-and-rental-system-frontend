...
import { faBoxArchive, faCar, faCartShopping, faCircleCheck, faCircleXmark, faClock, faLocationDot, faPhone, faStopwatch, faThumbTack, faUser } from '@fortawesome/free-solid-svg-icons'
                ...
                <Tab eventKey="information" title="Thông tin">
                  ...
                  <Row>
                    ...
                    <span className={cx('content')}>
                      Toyota Vios G là sự kết hợp hoàn hảo giữa tiết kiệm nhiên liệu và hiệu suất vận hành. - Với động
                      cơ 1.5L sản sinh công suất cực đại 107 mã lực cùng với hộp số vô cấp CVT mang đến sự trải nghiệm
                      mượt mà và tiết kiệm nhiên liệu. - Nội thất rộng rãi và tính năng tiện nghi như hệ thống giải trí
                      đa phương tiện, Vios G là một sự lựa chọn đáng tin cậy cho cuộc sống hàng ngày.
                    </span>
                  </Row>
                  <Row>
                ...
                <Tab eventKey="policy" title="Điều khoản">
                  <Row>
                    ...
                    <span className={cx('content')}>
                      ...
                      sử dụng xe thuê để cầm cố, thế chấp. - Không hút thuốc, nhả kẹo cao su, xả rác trong xe. - Không
                      chở hàng quốc cấm dễ cháy nổ. - Không chở hoa quả, thực phẩm nặng mùi trong xe. - Khi trả xe, nếu
                      xe bẩn hoặc có mùi trong xe, khách hàng vui lòng vệ sinh xe sạch sẽ hoặc gửi phụ thu phí vệ sinh
                      xe. - Xe được giới hạn di chuyển ở mức 400km cho 24h, và lần lượt là 250km, 300km, 350 km cho gói
                      4h, 8h, 12h. Trân trọng cảm ơn, chúc quý khách hàng có những chuyến đi tuyệt vời !
                    </span>
                  </Row>
                  <Row>
