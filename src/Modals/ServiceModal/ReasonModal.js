...
function ReasonModal() {
  const { isOpenModal, closeModal } = useServiceModal()
  ...
  return (
    <Modal show={isOpenModal.cancel} onHide={() => closeModal('cancel')} centered size="md">
      ...
      <Modal.Body>
        <form>
          ...
          <div className="d-flex column-gap-3 justify-content-end mt-5">
            <Button text onClick={() => closeModal('cancel')} className={cx("btn-cancel")} type='button'>Thoát</Button>
